...
import { a as SITE_URL, S as SITE_TITLE, e as SITE_DESCRIPTION, D as DEFAULT_OG_IMAGE, M as MY_TWITTER_HANDLE, c as REPO_URL } from "../../chunks/siteConfig.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  items = data.items;
  return `${$$result.head += `<!-- HEAD_svelte-1voan3v_START -->${$$result.title = `<title>${escape(SITE_TITLE)}</title>`, ""}<link rel="canonical"${add_attribute("href", SITE_URL, 0)}><link rel="alternate" type="application/rss+xml"${add_attribute("href", SITE_URL + "/rss.xml", 0)}><meta property="og:url"${add_attribute("content", SITE_URL, 0)}><meta property="og:type" content="article"><meta property="og:title"${add_attribute("content", SITE_TITLE, 0)}><meta name="Description"${add_attribute("content", SITE_DESCRIPTION, 0)}><meta property="og:description"${add_attribute("content", SITE_DESCRIPTION, 0)}><meta property="og:image"${add_attribute("content", DEFAULT_OG_IMAGE, 0)}><meta name="twitter:card" content="summary"><meta name="twitter:creator"${add_attribute("content", "@" + MY_TWITTER_HANDLE, 0)}><meta name="twitter:title"${add_attribute("content", SITE_TITLE, 0)}><meta name="twitter:description"${add_attribute("content", SITE_DESCRIPTION, 0)}><meta name="twitter:image"${add_attribute("content", DEFAULT_OG_IMAGE, 0)}><!-- HEAD_svelte-1voan3v_END -->`, ""} <div class="flex flex-col items-start justify-center max-w-2xl px-4 pb-16 mx-auto border-gray-200 dark:border-gray-700 sm:px-8"><div class="flex flex-col-reverse items-start sm:flex-row"><div class="flex flex-col pr-8"><h1 class="mb-3 text-3xl font-bold tracking-tight text-black dark:text-white md:text-5xl">This is

				<span class="relative inline-block ml-2 before:absolute before:-inset-1 before:block before:-skew-y-3 before:bg-red-500"><span class="relative text-yellow-400 skew-y-3">${escape(SITE_TITLE)}</span></span>
				!</h1> <h2 class="mb-4 text-gray-700 dark:text-gray-200" data-svelte-h="svelte-efra4x">An opinionated blog starter for <span class="font-semibold">SvelteKit + Tailwind + Netlify/Vercel.</span> Updated for
				<a href="https://github.com/sveltejs/kit/">SvelteKit 1.0</a>!</h2> <p class="mb-16 text-gray-600 dark:text-gray-400" data-svelte-h="svelte-1s4spte"><a${add_attribute("href", REPO_URL, 0)}>View source and feature list here!</a></p></div> </div> <section class="w-full mb-16"><h3 class="mb-6 text-2xl font-bold tracking-tight text-black dark:text-white md:text-4xl" data-svelte-h="svelte-hqbh27">Featured Posts</h3> <div class="flex flex-col gap-6 md:flex-row">${validate_component(FeatureCard, "FeatureCard").$$render(
    $$result,
    {
