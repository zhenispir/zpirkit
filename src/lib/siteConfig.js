export const SITE_URL = 'https://www.zhenispir.com';
export const APPROVED_POSTERS_GH_USERNAME = ['zhenispir'];
...
export const POST_CATEGORIES = ['Tutorial', 'Essay', 'Project', 'English', 'Kazakh']; // Other categories you can consider adding: Talks, Tutorials, Snippets, Podcasts, Notes...
